...
def main():
    ...
    parser.add_argument("--logdir", type=str, default='logs/qnn_data_kfold', help="Logging directory.")
    parser.add_argument("--modeldir", type=str, default='models/qnn_data_kfold', help="Models directory.")
